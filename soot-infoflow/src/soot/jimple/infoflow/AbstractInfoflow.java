...
public abstract class AbstractInfoflow implements IInfoflow {
  ...
  @Override
  public void computeInfoflow(String appPath, String libPath, IEntryPointCreator entryPointCreator, List<String> sources,
      List<String> sinks) {
    this.computeInfoflow(appPath, libPath, entryPointCreator, new DefaultSourceSinkManager(sources, sinks));
  }

  @Override
  public void computeInfoflow(String appPath, String libPath, Collection<String> entryPoints, Collection<String> sources,
   ...
   * @param classes
   *          The set of classes that shall be checked for data flow analysis seeds. All sources in these classes are used as
   *          seeds.
   */
   ...
   * @param classes
   *          The set of classes that shall be checked for data flow analysis seeds. All sources in these classes are used as
   *          seeds. If a non-empty extra seed is given, this one is used too.
   */
