...
public class AndroidEntryPointUtils {
  ...
  public enum ComponentType {
    Application, Activity, Service, Fragment, BroadcastReceiver, ContentProvider, GCMBaseIntentService, GCMListenerService,
    ServiceConnection, Plain
  }

  /**
   * Creates a new instance of the {@link AndroidEntryPointUtils} class. Soot must already be running when this constructor
   * is invoked.
   */
   ...
   * @param clazz
   *          The class to check
   * @return True if the given class is derived from android.app.Application, otherwise false
   */
  ...
  /**
   * Checks whether the given method is an Android entry point, i.e., a lifecycle method
   * 
   * @param method
   *          The method to check
